...
label mom_bed:
    if M_mom.is_set("panties taken"):
        ...
        menu mom_sleep_options:
            ...
            "Breastfeed" if M_mom.finished_state(S_mom_movie_night_two) or store._in_replay is not None:
                if M_mom.is_set("sex available"):
            ...
            "Rub" if M_mom.finished_state(S_mom_movie_night_two) or store._in_replay is not None:
                if M_mom.is_set("sex available"):
