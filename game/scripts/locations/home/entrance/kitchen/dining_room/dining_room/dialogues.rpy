label dining_room_mom_diane_dinner:
    scene location_home_dining
    show jenny 44 at Position(xpos=0.1161,ypos=1.0000)
    show player 213 at Position(xpos=0.5972,ypos=1.0118)
    show diane 128 at Position(xpos=0.3483,ypos=1.0118)
    ...
    pause
    show player 221
    show debbie 69 at Position(xpos=0.7992,ypos=1.0118)
    pause
    show player 222
    show debbie 70 at Position(xpos=0.7992,ypos=1.0118)
    pause
    ...
    pause
    show player 222
    show diane 135 at Position(xpos=0.3981,ypos=1.0118)
    pause
    show jenny 47
    show player 226
...
label dining_room_sis_breakfast:
    pause
    show jenny 45
    show player 317
    pause
