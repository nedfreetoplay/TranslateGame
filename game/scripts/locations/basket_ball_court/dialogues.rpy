label basketball_court_dexter_start:
    ...
    show player 12
    player_name "Что тебе надо, {b}Dexter{/b}?"
    show player 5
...
label basketball_court_roxxy_dexter_argument:
    ...
    show roxxy 3bf
    show dexter 8
    dex "Перестань называть меня глупым, {b}Roxxy{/b}!"
    show dexter 2
    show roxxy 31f
    rox "... ТЫ ГЛУПЫЙ!"
    show roxxy 3bf
    ...
    dex "Я покнчу с этим!"
    show dexter 6 with dissolve
    dex "Всегда, \"{b}Dexter{/b} сделай это.\" \"{b}Dexter{/b} сделай то.\""
    dex "... И что в итоге?"
    dex "Я - глупый."
    dex "Что ж, пошла ты в задницу {b}Roxxy{/b}!"
    ...
    player_name "Мне как-то жалко {b}Dexter{/b}."
    show player 5
    show eve 2b
    eve "Ухх..."
    eve "Не говори так."
...
label basketball_court_bissette_get_books:
    ...
    with dissolve
    player_name "Хей, умм, {b}Dexter{/b}..."
    show player 5
    show dexter 3
    dex "Че надо ЧМО?"
    show dexter 1
...
label basketball_court_ross_magazines_intro:
    ...
    show dexter 24
    dex "Это чмо беспокоит тебя, Becca?"
    show dexter 23
    show becca 2bf
    ...
    show dexter 25_26
    with dissolve
    dex "Думаю, мне лучше забрать их, пока ты не заразил ее!"
    return
...
label basketball_court_roxxy_dexter_alcohol_fight:
    ...
    show roxxy 29f
    show becca 2
    becca "Давай {b}Roxxy{/b}, извенись..."
    ...
    show roxxy 29f
    show dexter 8
    dex "О, сначала я глупый, а теперь еще и ребенок..."
    dex "Уточни?"
    show dexter 2
    show roxxy 3bf
    rox "..."
    ...
    show missy 3
    show dexter 8
    dex "Эй!! Не смейся надо мной, {b}Missy{/b}!"
    show dexter 2
    show missy 2b
    missy "..."
    show missy 2
    ...
    with dissolve
    eve "Черт!"
    eve "{b}Dexter{/b} отшили!"
    show eve 5
    show player 14
    player_name "Да,не хотел бы я попасть ему на пути."
    show player 13
    show eve 5
    eve "Реально!"
    eve "Пойдем, нам нужно вернуться в {b}класс Miss Bissette{/b}."
    hide eve
    hide player
    show player 4
    with dissolve
...
label basketball_court_roxxy_basketball_challenge:
    ...
    show dexter 31
    show player 12
    player_name "На этот раз ты проиграешь, {b}Dexter{/b}."
    show player 90
    show dexter 3
    dex "Хахаха!"
    dex "Ага, точно."
