...
label trailer_bedroom_roxxy_wait_in_her_room_won_shooting:
    ...
    pause
    show roxxy 22
    show roxxy_outfit shorts undress
    with dissolve
    pause
    show roxxy 23b
...
label trailer_bedroom_roxxy_go_to_picnic:
    scene expression game.timer.image("trailer_bedroom{}_blur")
    show roxxy 87 at right
    ...
    with dissolve
    pause
    scene expression "backgrounds/location_trailer_cutscene03.jpg"
    show rain
    with fade
    dex "..."
    ...
    with dissolve
    scene expression game.timer.image("trailer_bedroom{}_blur")
    show roxxy 17cf at Position (xpos=300)
    show roxxy_wet_undies_f at Position (xpos=300)
