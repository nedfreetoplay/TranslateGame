label trailerpark_roxxy_go_to_picnic:
    ...
    hide text
    with dissolve
    scene expression "backgrounds/location_trailer_park_mud_night.jpg"
    ...
    with dissolve
    scene expression "backgrounds/location_trailer_park_mud_night.jpg"
    show roxxy 90f at left
    show roxxy_wet hurt_f at left
    ...
    show roxxy 1kf at Position (xpos=334)
    show roxxy_wet_f at Position (xpos=334)
    show player 13 at left
