label rump_mall_dialogue_pre:
    ...
    pause
    show rump 2
    rump "Добрый День, граждане Саммервилля."
    rump "Именно благодаря вашей усердной работе и преданности делу Я горд возможностью находиться сегодня здесь и говорить..."
    ...
    rump "Мы возьмем этот жалкий Торговый центр, и превратим его в великий {b}ТОРГОВЫЙ ЦЕНТР{/b}!"
