label sister_triggers_init:
    python:
        ...
        T_jenny_panty_caught = Trigger("panty raid", "Steal Jenny's panties")
        T_jenny_panty_bought = Trigger("panty raid", "Steal Jenny's panties")
        T_jenny_somrak_panty_traded = Trigger("panty raid", "Steal Jenny's panties")
        T_jenny_peep_cuddle = Trigger("panty raid", "Steal Jenny's panties")
        T_jenny_somrak_training_halt = Trigger("panty raid", "Steal Jenny's panties")
        T_jenny_panty_sex_toy_traded = Trigger("panty raid", "Steal Jenny's panties")
        T_jenny_somrak_panty_traded_tier_2 = Trigger("panty raid", "Steal Jenny's panties")
        T_jenny_tricked = Trigger("panty raid", "Steal Jenny's panties")
        T_jenny_diary_read = Trigger("panty raid", "Steal Jenny's panties")
        T_jenny_webcam_connected = Trigger("panty raid", "Steal Jenny's panties")
        T_jenny_watched_stream = Trigger("panty raid", "Steal Jenny's panties")
        T_jenny_spied_on_neighbour = Trigger("panty raid", "Steal Jenny's panties")
        T_jenny_debbie_mention_breakfast = Trigger("panty raid", "Steal Jenny's panties")
        T_jenny_breakfast_done = Trigger("panty raid", "Steal Jenny's panties")
        T_jenny_paid_for_titties = Trigger("panty raid", "Steal Jenny's panties")
        T_jenny_peep_cuddle_tier_2 = Trigger("panty raid", "Steal Jenny's panties")
        T_jenny_hallway_chat = Trigger("panty raid", "Steal Jenny's panties")
        T_jenny_couch_fun = Trigger("panty raid", "Steal Jenny's panties")
        T_jenny_couch_fun_tier_2 = Trigger("panty raid", "Steal Jenny's panties")
        T_jenny_somrak_training_halt_tier_2 = Trigger("panty raid", "Steal Jenny's panties")
...
label sister_fsm_init:
    python:
        ...
        S_jenny_busy = State("bored", "Waiting for something to happen")
        S_jenny_panty_steal = State("Bedroom1", "Waiting for panty raid")
        S_jenny_panty_deal = State("Bedroom1", "Waiting for panty raid")
        S_jenny_somrak_panty_trade = State("Bedroom1", "Waiting for panty raid")
        S_jenny_shower_peep_bed_cuddle = State("Bedroom1", "Waiting for panty raid")
        S_jenny_somrak_more_panty = State("Bedroom1", "Waiting for panty raid")
        S_jenny_panty_deal_tier_2 = State("Bedroom1", "Waiting for panty raid")
        S_jenny_somrak_panty_trade_tier_2 = State("Bedroom1", "Waiting for panty raid")
        S_jenny_debbie_needs_jenny = State("Bedroom1", "Waiting for panty raid")
        S_jenny_read_diary = State("Bedroom1", "Waiting for panty raid")
        S_jenny_connect_webcam = State("Bedroom1", "Waiting for panty raid")
        S_jenny_watch_stream = State("Bedroom1", "Waiting for panty raid")
        S_jenny_telescope_spying = State("Bedroom1", "Waiting for panty raid")
        S_jenny_debbie_breakfast = State("Bedroom1", "Waiting for panty raid")
        S_jenny_breakfast = State("Bedroom1", "Waiting for panty raid")
        S_jenny_titty_deal = State("Bedroom1", "Waiting for panty raid")
        S_jenny_shower_peep_bed_cuddle_tier_2 = State("Bedroom1", "Waiting for panty raid")
        S_jenny_hallway_meetup = State("Bedroom1", "Waiting for panty raid")
        S_jenny_couch_naughty_time = State("Bedroom1", "Waiting for panty raid")
        S_jenny_couch_naughty_time_tier_2 = State("Bedroom1", "Waiting for panty raid")
        S_jenny_somrak_more_panty_tier_2 = State("Bedroom1", "Waiting for panty raid")
        S_jenny_panty_deal_tier_3 = State("Bedroom1", "Waiting for panty raid")
        S_jenny_somrak_panty_trade_tier_3 = State("Bedroom1", "Waiting for panty raid")
        S_jenny_watch_stream_tier_2 = State("Bedroom1", "Waiting for panty raid")
        S_jenny_telescope_spying_tier_2 = State("Bedroom1", "Waiting for panty raid")
        S_jenny_hallway_meetup_focus = State("Bedroom1", "Waiting for panty raid")
        S_jenny_shower_peep_bed_cuddle_tier_3 = State("Bedroom1", "Waiting for panty raid")
        S_jenny_couch_naughty_time_tier_3 = State("Bedroom1", "Waiting for panty raid")
        S_jenny_somrak_more_panty_tier_3 = State("Bedroom1", "Waiting for panty raid")
        S_jenny_panty_deal_tier_4 = State("Bedroom1", "Waiting for panty raid")
        S_jenny_somrak_panty_trade_tier_4 = State("Bedroom1", "Waiting for panty raid")
        S_jenny_watch_stream_tier_3 = State("Bedroom1", "Waiting for panty raid")
        S_jenny_telescope_spying_tier_3 = State("Bedroom1", "Waiting for panty raid")
        S_jenny_shower_peep_bed_cuddle_tier_4 = State("Bedroom1", "Waiting for panty raid")
        S_jenny_hallway_noises = State("Bedroom1", "Waiting for panty raid")
        S_jenny_overhear_caught = State("Bedroom1", "Waiting for panty raid")
        S_jenny_cam_show = State("Bedroom1", "Waiting for panty raid")
        S_jenny_shower_peep_bed_cuddle_tier_5 = State("Bedroom1", "Waiting for panty raid")
        S_jenny_help_stream_tier_4 = State("Bedroom1", "Waiting for panty raid")
        S_jenny_prepare_stream_tier_4 = State("Bedroom1", "Waiting for panty raid")
