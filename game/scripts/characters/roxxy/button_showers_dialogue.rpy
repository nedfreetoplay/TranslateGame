label button_roxxy_showers_check_on_roxxy:
    scene expression "backgrounds/location_beach_shower_day_blur.jpg"
    show roxxy bikini 21 at Position (xpos=600)
    ...
    show player 11f
    show becca bikini 6
    show roxxy bikini 24f with dissolve
    rox "!!!" with hpunch
    player_name "!!!"
    ...
    show roxxy bikini 12 at Position (xoffset=3)
    show player 428f
    show roxxy bikini 13 at Position (xoffset=-30)
    pause
    rox "Eep!"
...
label button_roxxy_showers_in_cabin:
    scene expression "backgrounds/location_beach_shower_day_blur.jpg"
...
label button_roxxy_showers_get_new_bikini:
    scene expression "backgrounds/location_beach_shower_day_blur.jpg"
    show becca bikini 2 at Position(xpos=315)
    show missy bikini 1 at left
...
label button_roxxy_showers_get_oil:
    scene expression "backgrounds/location_beach_shower_day_blur.jpg"
