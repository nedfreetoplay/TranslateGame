label kevin_dialogue_ross_find_magazines:
    ...
    show player 1
    show kevin 30b
    kev "Ох, просто некоторые журналы которые я взял с спортзала."
    show player 2
    show kevin 29b
    ...
    player_name "..."
    show player 10
    player_name "Ох,точно... Ты думаешь что я могу взять один из этих журналов?"
    show player 11
...
label kevin_dialogue_dewitt_kevin_give_guitar:
    ...
    kev "Эта вешь самой лучше подделки!"
    show kevin 14f
    show player 10
    player_name "Эта?"
    show player 5
    ...
    show kevin 14f
    show player 14
    player_name "Вообще-то её одолжил, у моего друго.Так что будь остороже с ней, да?"
    hide player
    ...
    kev "Я должен!"
    show kevin 28
    player_name "Потрясно!Увидимся тогда скоро в кабинете {b}Ms. Dewitt's{/b} чтобы потренироваться!"
    show kevin 27
...
label kevin_dialogue_talent_show_help:
    show player 10
    player_name "Я помогаю {b}Ms. Dewitt{/b} найти добровольцев для шоу талантов."
...
label kevin_dialogue_talent_show_replace_guitar:
    ...
    show kevin 23
    show player 34
    player_name "( Я должен поменять мою само-сделанную гитару с той что в подвале у {b}Erik's{/b}! )"
    show player 14
    player_name "Я приду!"
    show player 13
    show kevin 24
...
label kevin_dialogue_dewitt_science_adhesive:
    ...
    show kevin 1
    show player 14
    player_name "Круто!Спасибо, {b}Kevin{/b}!"
    return

label kevin_dialogue_leave:
    show player 14
    player_name "Увидимся позже, {b}Kevin{/b}."
    show player 13
    show kevin 9b
    kev "Позже!"
    return
