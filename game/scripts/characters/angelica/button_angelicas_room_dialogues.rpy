label angelicas_room_dialogue_helen_route_pre:
    ...
    with dissolve
    ang "Добрый вечер, {b}[firstname]{/b}. Ты пришел помочь мне в моем обучении {b}Елена{/b}?"
    show ang 5f
    show player 10f
    ...
    with dissolve
    ang "Сейчас."
    ang "Есть что-то особенное, что ты хотел бы сделать с {b}Елена{/b}?"
    show ang 10
    return
...
label angelicas_room_dialogue_helen_route_spanking:
    ...
    hide player
    with dissolve
    ang "Покайся, {b}Елена{/b}!"
    ang "Почувствуй гнев {b}Божий{/b}, лижущий твой зад!"
    hide helen
    show ang 19
    with dissolve
    pause
    show ang 20 with dissolve
    "{b}[sim_crack]{/b}" with hpunch
    show helen whip 1 at Position (xpos=161)
    ...
    show helen whip 1 at Position (xpos=161)
    show ang 17 at Position (xoffset=312) with dissolve
    helen "Ещё! Накажи мою грешную плоть!"
    show ang 18 at Position (xoffset=312)
...
label angelicas_room_dialogue_helen_route_holy_seed:
    show player 10f
    player_name "Я здесь, чтобы помочь очистить {b}Елена{/b} от греха."
    show ang 9
...
label angelicas_room_dialogue_helen_route_spread_helen:
    show player 24f
    player_name "Не могли бы вы... сказать {b}Елена{/b}..." # Тут возможно бред...
    show ang 9
    ang "Киску?"
    ang "Полагаю, я смогу это сделать."
    ang "Сначала ты должен раздеться."
    ang "Я хочу посмотреть, как киска {b}Елены{/b} возбуждает тебя."
    show ang 10
    pause
    player_name "Хорошо."
    ...
    helen "Да..."
    show ang 26f
    ang "Тише, шлюха. Я спрашиваю {b}[firstname]{/b}."
    show ang 22_23_24f
    show player 430bf
    player_name "Да."
    pause
...
label angelicas_room_dialogue_mia_find_sinners:
    ...
    ang "Приведите мне {b}Елену{/b}, женщину из исповеди, чтобы мы могли начать наши встречи..."
    show ang 1
    show player 12
...
label helen_sacrement_training_part2_pre:
    ...
    show player 11f
    show ang 18f
    ang "Проводить. Я хочу, чтобы ты остался для следующего шага в очищении {b}Елены{/b}.."
    ang "{b}Елена{/b} сказала мне, что ты видел, как она оскверняла свое тело на днях."
    ...
    pause
    show ang 18f
    ang "Как видишь: {b}Елена{/b} все ещё сомневается в моих методах."
    ...
    show helen 29
    show ang 18f
    ang "{b}Елена{/b}, радуйся! Сегодня начинается 2-й ритуал таинства очищения!"
    ...
    show helen 29
    show ang 18f
    ang "{b}Елена{/b}. Я не прошу вас начинать мастурбировать перед ним, как раньше."
    ...
    pause
    show ang 14 with dissolve
    ang "Я сдерживаю вас {b}Елена{/b}, так как ваш греховный импульс будет охватывать вас."
    hide helen
    show ang 15
    with dissolve
    ...
    show helen whip 1 at Position (xpos=161)
    show ang 18 at Position (xoffset=312) with dissolve
    ang "Не сдавайся так легко {b}Елена{/b}!"
    ang "Вам нужно это!"
    hide helen
    show ang 19
    with dissolve
    ...
    ang "{b}Елена{/b}, Мне нужно услышать, как ты это скажешь...."
    helen "Я-"
    hide helen
    show ang 19
    with dissolve
    ...
    show helen whip 1 at Position (xpos=161)
    show ang 18 at Position (xoffset=312) with dissolve
    ang "Что это? Вам нравится это, {b}Елена{/b}?"
    hide helen
    show ang 19
    with dissolve
    pause
    ...
    show helen whip 1 at Position (xpos=161)
    show ang 18 at Position (xoffset=312) with dissolve
    ang "Шлюха! Сначала вы мастурбировали перед этим молодым человеком, а теперь наслаждаетесь избиением."
    ...
    show helen whip 1 at Position (xpos=161)
    show ang 18 at Position (xoffset=312) with dissolve
    ang "Так вульгарно, {b}Елена{/b}. Теперь попроси меня побольше хлестать тебя... Шлюха."
    show ang 17 at Position (xoffset=312)
    ...
    helen "Да..."
    show ang 18f
    ang "Спасибо, что принес мне хлыст. {b}Елена{/b}."
    show ang 17f
    show player 11f
    ...
    ang "{b}Елене{/b} потребуется дальнейшее обучение, но сначала мне нужно, чтобы она была более подчиненной и более терпимой к болям этого мира."
...
label helen_sacrement_training_part2_after:
    ...
    show player 12
    player_name "Это безумие! Я должен рассказать кому-то, но сестра Анжелика, похоже, имеет большой контроль над {b}Еленой{/b}."
    player_name "{b}Елена{/b} наверное, скажет, что охотно участвует..."
    show player 25
...
label angelicas_room_dialogue_mia_angelicas_final_request_strap_on:
    show helen 37 at Position (xpos=575) with None
    show ang 5f at left with None
    show player 460f at right
    show player 460f at Position (xoffset=-1)
    with dissolve
