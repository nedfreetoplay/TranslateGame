...
label INIT_INVENTORY_ITEMS:
    python:
        sea_dogs_saga = ComicItem("game", "PC Game - Sea Dogs Saga", "", "boxes/popup_item_game.png", Transform("game_1"), Transform("game_1b"), 100, "Video Games")
        world_of_orcette = ComicItem("game02", "PC Game - World of Orcette", "", "boxes/popup_item_game2.png", Transform("game_2"), Transform("game_2b"), 100, "Video Games")
        orcette_outfit = ComicItem("orcette_cosplay", "Cosplay Outfit - Orcette Queen", "", "boxes/popup_cosplay.png", Transform("cosplay_1"), Transform("cosplay_1b"), 300, "Cosplay")
        cyclone_mask = ComicItem("cyclone_mask", "Wrestler Mask - Cyclone", "", "boxes/popup_item_mask01.png", "objects/item_mask1.png", HoverImage("objects/item_mask1.png"), 100, "Cosplay", False, "M_jenny.finished_state(S_jenny_get_a_mask)", cyclone_mask_callback)
        cock_goblin = ComicItem("card01", "Trading Card - The Flying Cock Goblin", "objects/closeup_card01.png", "boxes/popup_item_card1.png", "objects/item_card1.png", HoverImage("objects/item_card1.png"), 50, "Collectible")
        cock_crown = ComicItem("card02", "Trading Card - Cock Crown of Thorns", "objects/closeup_card02.png", "boxes/popup_item_card2.png", Transform("card_2"), Transform("card_2b"), 50, "Collectible")
        ...
        cupidstore.items = [plush1, plush2, plush3, plush4, plush5, plush6, plush7, plush8, plush9, 
                            ...
                            flower6, flower7, necklace1, necklace2, necklace3]
    return
