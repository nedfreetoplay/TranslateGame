...
label rapbattle_listing:
    ...
    $ tyrone6 = Rap(line = "Ты не на улице, ты,отмечен как заноза в заднице, \nя был повсюду вокруг, ты не оставил этот ____.", rhymes = ["парк", "темноту", "искру"], answer = "park")
    ...
    $ tyrone14 = Rap(line = "Ты думаешь, что избил меня, когда я истекал кровью? \nЭто история неудачника, в этом вся моя мотивация  ____.", rhymes = ["необходима", "бусина", "подвиг"], answer = "need")
    ...
    $ tyrone25 = Rap(line = "Я остановлю тебя прямо здесь, ясно, что ты закончил. \nУ тебя закончился рэп, и я должен ____.", rhymes = ["тонну", "телефон", "ничего"], answer = "ton")
