    ...
    class MilkingMinigame(renpy.Displayable):
        ...
        def render(self, width, height, st, at):
            ...
            if renpy.variant("mobile"):
                instructions_r = renpy.render(Text("Нажмите на кнопки, чтобы доить ее!", style = "style_instructions"), width, height, st, at)
            else:
                instructions_r = renpy.render(Text("Нажмите A и D, чтобы доить ее!", style = "style_instructions"), width, height, st, at)
